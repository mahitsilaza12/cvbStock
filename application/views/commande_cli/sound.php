...
header('content-Disposition:attachement;filename="payement.xls"');
...
<table style="margin:50px auto 10px auto;height: 400px;border-collapse: collapse;border:1px solid black;text-align: center">
	...
	<tr>		
		<td style="width: 11%;border:1px solid black;color:blue">nom_client</td>		
...
if($excels['payee']==$excels['net'] )
 ...
 if($excels['numfact'] == $last)
     ...
     ?>
      <tr>
        <td style="width: 11%;border:1px solid black"><?php echo $excels['nom_client'] ?></td>
