...
<div class="col-md-6 col-md-10"class="row" style="height:650px;margin-left:-13px;margin-right:200px; box-shadow: 0px 20px 30px; margin-top:60px; left:229px;position:fixed;"> 
                    <div style="height:30x; margin-top:10px; ">
                            ...
                            <ol class="breadcrumb  text-info float-right" style="left:30px; margin-top:-50px;font-size:20px;">
                                ...
                                <h1 style="text-aligne:center;">Journal pour les commande</h1>
                                </div>
                            
                                <div class="alert alert-info col-md-12" role="alert">
                                <form class="needs-validation"  method="POST" action="<?php echo base_url(). 'index.php/commande_cli/chi'; ?>">
                                <div class="row">
                                    ...
                                    <a style="margin-left:0px;" id="tel" class="btn btn-success btn-xr" href="<?=  base_url()?>index.php/commande_cli/exdep/<?= $date1.'/'.$date2?>"><span><i class="fas fa-download"></i></span> Telecharger</a> 
                                    <?php }else{
                                     ?>

                                      <a style="margin-left:0px;" id="tel" class="btn btn-success btn-xr" href="<?php echo base_url(). 'index.php/commande_cli/exdep'; ?>"><span><i class="fas fa-download"></i></span> Telecharger</a> 
                                   <?php } ?>
                                ...
                                <table class="table table-dark">
                                    <thead class="thead bg-info text-white">
                                      ...
                                      <th scope="col">client</th>
                                        ...
                                        <th scope="col">date_de_commande</th>
