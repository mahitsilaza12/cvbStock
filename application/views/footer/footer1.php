...
<footer class="flex-rw">
  ...
  <!-- <ul class="footer-list-top">
    <li>
      <h4 class="footer-list-header" style="font-size: 11px;">About Pavilion</h4></li>
 ...
 <li>
      <h4 class="footer-list-header" style="font-size: 11px;"></h4></li>

  <li><h4 class="footer-list-header"></h4></li>
  ...
  <section class="footer-social-section flex-rw">
      ...
      <a href="https://www.pinterest.com/paviliongift/" class="generic-anchor" target="_blank" title="e-mail" itemprop="significantLink"><img src="images\mail1.jpg" style="width: 30px;height: 30px;"><i class="fa fa-pinterest"></i></a>
      <a href="https://www.facebook.com/paviliongift" class="generic-anchor" target="_blank" title="Facebook" itemprop="significantLink"><img src="images\facebook.png" style="width: 30px;height: 30px;"><i class="fa fa-facebook"></i></a>
      <a href="https://twitter.com/PavilionGiftCo" class="generic-anchor" target="_blank" title="Twitter" itemprop="significantLink"><img src="images\twitter.png" style="width: 30px;height: 30px;"><i class="fa fa-twitter"></i></a>
      <a href="http://instagram.com/paviliongiftcompany" class="generic-anchor" target="_blank" title="Instagram" itemprop="significantLink"><img src="images\insta.jpg" style="width: 30px;height: 30px;"><i class="fa fa-instagram"></i></a>
      <a href="https://www.youtube.com/channel/UCYgUODvd0qXbu_LkUWpTVEg" class="generic-anchor" target="_blank" title="Youtube" itemprop="significantLink"><img src="images\youtube.jpg" style="width: 30px;height: 30px;"><i class="fa fa-youtube"></i></a>
      <a href="deconnexion.php" class="generic-anchor" target="_blank" title="Déconnexion" itemprop="significantLink"><img src="images\shutdown.png" style="width: 30px;height: 30px;"><i class="fa fa-google-plus"></i></a>
      </span>
  </section>
...
</i>&copy 2019 Pavilion in <address class="footer-address" role="company address">Bergen, NY</address><span class="footer-bottom-rights"> - All Rights Reserved - </span>
    </div>
    <div class="footer-bottom-wrapper">
