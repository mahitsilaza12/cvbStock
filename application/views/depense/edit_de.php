  ...
  <!-- Modal -->
                    ...
                    <div class="col-md-6 col-md-10"class="row" style="height:650px;margin-left:-13px;margin-right:200px; box-shadow: 0px 20px 30px; margin-top:60px; left:229px;position:fixed;"> 
                        ...
                        <!-- <div style=";height:10px;margin-top:px;margin-right:180px;margin-left:px; box-shadow: 0px 20px 30px; width:100%;" class="container-fluid col-md-7 col-md-12 shadow-none p-3 mb-5 bg-light rounded"> -->
                                ...
                                <h3> </h3>Modification de depense </button></h1>
...
<!-- eto misy kozy -->
                                    ...
                                    <div style="margin-top:px;box-shadow: 0px 20px 30px;height:465px;margin-right: 0px;">
                                        ...
                                        <form method="post" name="edit_de" action="<?php echo base_url(). 'index.php/depense/edit_de/'.$depense['iddepense']; ?>" > 
                                        <div class="alert alert-primary" role="alert">
    
    <div class="form-group">
      <label >NOM</label>
      <input type="text" class="form-control" value="<?php echo set_value('nom',$depense['nom']); ?>" name="nom" placeholder="Enter nom">
      <?php //echo form_error('nom'); ?>
    </div>
    <div class="form-group">
      <label >MOTIF:</label>
      <input type="text" class="form-control" value="<?php echo set_value('motif',$depense['motif']); ?>" name="motif" placeholder="Enter motif">
      <?php //echo form_error('motif'); ?>
    </div>
    <div class="form-group">
      <label >MONTANT:</label>
      <input type="number" class="form-control" value="<?php echo set_value('montant',$depense['montant']); ?>" name="montant" >
      <?php //echo form_error('contact'); ?>
    </div>
    <div class="form-group">
      <label >DATE:</label>
      <input type="date" class="form-control" value="<?php echo set_value('date_depense',$depense['date_depense']); ?>" name="date_depense">
      <?php //echo form_error('contact'); ?>
    </div>
    
    <button type="submit" class="btn btn-primary">Modifier</button>
    <a href="<?php  echo base_url().'index.php/depense/index';?>" class="btn btn-info">Annuler</a>
    </div>
  </form>
                                        </div>
                                    </div>
