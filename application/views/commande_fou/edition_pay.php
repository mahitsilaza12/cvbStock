...
<!-- eto misy kozy -->
                                    ...
                                    <div style="margin-top:px;box-shadow: 0px 20px 30px;height:465px;margin-right: 0px;">
                                        ...
                                        <form method="post"  action="<?php echo base_url(). 'index.php/payement_fou/edit_pay/'.$payement_fou[0]['idcommande_fou']; ?>" >
                                        ...
                                        <h2>payement de reste a payee</h2>
                                              ...
                                              <div class="form-row" style="margin-top:50px;">
                                                ...
                                                <div class="form-group col-md-6">
                                                  ...
                                                  <input class="form-control" type="date" value="<?php echo set_value('date_payement',$payement_fou[0]['date_payement']); ?>" name="date_payement">
                                              ...
                                              <div class="form-group col-md-6">
                                                  ...
                                                  <input class="form-control" type="text" value="<?php echo set_value('type_d_payement',$payement_fou[0]['type_d_payement']); ?>" name="type_d_payement">
                                                </div>
                                             
                                                <div class="form-group col-md-6">
                                                  <label >date d'echemace </label>
                                                <th scope="col"><input class="form-control" type="date" value="<?php echo set_value('date_d_echeance',$payement_fou[0]['date_d_echeance']); ?>" name="date_d_echeance"></th>
                                              ...
                                              <button type="submit"  class="btn btn-primary containair-fluid">Regle</button>
                                              <a href="<?php  echo base_url().'index.php/payement_fou/payer';?>" class="btn btn-info">Annuler</a>
                                                  </div>
                                                  </div>
                                           </form>       
