...
<div class="col-md-6 col-md-10"class="row" style="height:650px;margin-left:-13px;margin-right:200px; box-shadow: 0px 20px 30px; margin-top:60px; left:229px;position:fixed;"> 
                    <div style="height:30x; margin-top:10px; ">
                            ...
                            Etat de CVB <span class="badge badge-primary"></span></button>Journal 
                            ...
                            <ol class="breadcrumb  text-info float-right" style="left:30px; margin-top:-50px;font-size:20px;">
                                ...
                                <h1 style="text-aligne:center;"><em> Journal des client est de fournisseur</em></h1>
                                </div>
                            

                                    <div class="alert alert-info" role="alert">
                                   cliquer ici si vous voulez voir les  <a href="<?php echo base_url().'index.php/commande_cli/journalcli'?>"><strong><em>Client</em></strong></a>
                                  
                                    </div>
                                    <div class="alert alert-dark" role="alert">
                                    cliquer ici si vous voulez voir les  <a href="<?php echo base_url().'index.php/commande_fou/journalfou'?>"><strong><em>Fournisseur</em></strong></a>
                                    </div>
                                    <div class="alert alert-dark" role="alert">
                                    cliquer ici si vous voulez voir les  <a href="<?php echo base_url().'index.php/commande_cli/chi'?>"><strong><em>le journal en chiffre</em></strong></a>
                                    </div>
                                    
                                    <div class="alert alert-info" role="alert">
                                   cliquer ici si vous voulez voir les  <a href="<?php echo base_url().'index.php/depense/journal'?>"><strong><em>depenses</em></strong></a>
                                  
                                    </div>

                                    <div class="alert alert-dark" role="alert">
                                    cliquer ici si vous voulez voir les  <a href="<?php echo base_url().'index.php/commande_fou/cho'?>"><strong><em>Appprovisionnement</em></strong></a>
                                    </div>
