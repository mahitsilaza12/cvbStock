...
<div class="col-md-6 col-md-10"class="row" style="height:650px;margin-left:-13px;margin-right:200px; box-shadow: 0px 20px 30px; margin-top:60px; left:229px;position:fixed;"> 
                    <div style="height:30x; margin-top:10px; ">
                            ...
                            Entree client <span class="badge badge-primary"></span></button>histogramme 
                            ...
                            <ol class="breadcrumb  text-info float-right" style="left:30px; margin-top:-50px;font-size:20px;">
                                ...
                                <div class="row">
                                    ...
                                    <input type="date" class="form-control" id="date1" name="date1" value="<?php echo set_value('date_commande') ?>"  required>
                                    </div>
                                    <div class="col col-md-2">
                                    <label for="">date fin</label>
                                    <input type="date" class="form-control" id="date2" name="date2" value="<?php echo set_value('date_commande') ?>"  required>
                                    </div>
                                    <div class="col" style="margin-top:30px;">
                                    <label for=""></label>
                                    <button id="entree" onclick="entree()" class="btn btn-primary"><span><i class="fas fa-history"></i></span> Entree</button>
