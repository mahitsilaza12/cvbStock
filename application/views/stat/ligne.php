...
<div>
  ...
  <!-- Modal -->
                    ...
                    <div class="col-md-6 col-md-10"class="row" style="height:850px;margin-left:-13px;margin-right:200px; box-shadow: 0px 20px 30px; margin-top:60px; left:229px;position:fixed;"> 
...
<!-- eto misy kozy -->
                                    ...
                                    <div  style="overflow:scroll;margin-top:10px;box-shadow: 0px 20px 30px;height:610px;margin-right: 0px;">
                                    <div class="alert alert-primary" role="alert">
                                        <div class="container col-md-6 clo-md-12 col-md-offset-3">
                                        <div class="container" style="height:590px">  
                                        <h1>Statistique en ligne pour les commnande des client</h1>
                                     <canvas id="chart1"  ></canvas>




                                <h3>Placer les souris sur la ligne pour afficher les resultat</h3>               
